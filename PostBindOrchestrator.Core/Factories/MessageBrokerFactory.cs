...
{
    public static PublisherBase CreateMessageBrokerPublisher(MessageBrokerType messageBrokerType)
    {
    ...
    public static SubscriberBase CreateMessageBrokerSubscriber(MessageBrokerType messageBrokerType)
    {
        return messageBrokerType switch
        {
